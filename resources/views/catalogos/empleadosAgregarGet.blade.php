...
<form method="post" action="{{url('catalogos/empleados/agregar')}}">
    ...
    <div class="row my-4">
        ...
        <div class="form-group mb-3 col-6"><label for="fecha ingreso">Fecha de Ingreso</label>
        <input type="date" name="fecha_ingreso" id="fecha_ingreso" class="form-control" required></div>
    </div>
    <div class="row my-3">
